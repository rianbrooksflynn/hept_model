...
unsigned config5_transpose_qk_from_shape[4] = {2, 4, 4, 5};
unsigned config5_transpose_qk_to_shape[4] = {4, 2, 4, 5};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {20, 80, 5, 1};
