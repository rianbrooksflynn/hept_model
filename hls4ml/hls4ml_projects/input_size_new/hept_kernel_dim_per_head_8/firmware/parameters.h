...
unsigned config5_transpose_qk_from_shape[4] = {2, 4, 4, 10};
unsigned config5_transpose_qk_to_shape[4] = {4, 2, 4, 10};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {40, 160, 10, 1};
...
unsigned config5_transpose_v_from_shape[4] = {2, 4, 4, 8};
unsigned config5_transpose_v_to_shape[4] = {4, 2, 4, 8};
unsigned config5_transpose_v_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_v_perm_strides[4] = {32, 128, 8, 1};
...
unsigned config5_transpose_output_from_shape[4] = {4, 2, 4, 8};
unsigned config5_transpose_output_to_shape[4] = {2, 4, 4, 8};
unsigned config5_transpose_output_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_output_perm_strides[4] = {32, 64, 8, 1};
...
struct config5 : nnet::hept_config {
    ...
    static const unsigned dim_per_head = 8;
