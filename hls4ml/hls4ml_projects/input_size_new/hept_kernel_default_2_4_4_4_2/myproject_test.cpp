...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input2_t, 192, N_INPUT_1_2*N_INPUT_2_2*N_INPUT_3_2>(in, key);
      input3_t value[N_INPUT_1_3*N_INPUT_2_3*N_INPUT_3_3];
      nnet::copy_data<float, input3_t, 384, N_INPUT_1_3*N_INPUT_2_3*N_INPUT_3_3>(in, value);
      input4_t padding_mask[N_INPUT_1_4*N_INPUT_2_4];
      nnet::copy_data<float, input4_t, 512, N_INPUT_1_4*N_INPUT_2_4>(in, padding_mask);
