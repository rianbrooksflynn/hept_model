...
unsigned config5_transpose_qk_from_shape[4] = {6, 2, 2, 4};
unsigned config5_transpose_qk_to_shape[4] = {2, 6, 2, 4};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {8, 16, 4, 1};
...
unsigned config5_transpose_v_from_shape[4] = {6, 2, 2, 2};
unsigned config5_transpose_v_to_shape[4] = {2, 6, 2, 2};
...
unsigned config5_transpose_output_from_shape[4] = {2, 6, 2, 2};
unsigned config5_transpose_output_to_shape[4] = {6, 2, 2, 2};
unsigned config5_transpose_output_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_output_perm_strides[4] = {4, 24, 2, 1};
