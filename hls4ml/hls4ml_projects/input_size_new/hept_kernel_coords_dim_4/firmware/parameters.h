...
unsigned config5_transpose_qk_from_shape[4] = {2, 4, 4, 8};
unsigned config5_transpose_qk_to_shape[4] = {4, 2, 4, 8};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {32, 128, 8, 1};
...
unsigned config5_transpose_v_from_shape[4] = {2, 4, 4, 4};
unsigned config5_transpose_v_to_shape[4] = {4, 2, 4, 4};
unsigned config5_transpose_v_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_v_perm_strides[4] = {16, 64, 4, 1};
...
unsigned config5_transpose_output_from_shape[4] = {4, 2, 4, 4};
unsigned config5_transpose_output_to_shape[4] = {2, 4, 4, 4};
...
struct config5 : nnet::hept_config {
    ...
    static const unsigned coords_dim = 4;
