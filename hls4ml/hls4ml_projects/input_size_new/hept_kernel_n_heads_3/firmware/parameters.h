...
unsigned config5_transpose_qk_from_shape[4] = {3, 4, 4, 6};
unsigned config5_transpose_qk_to_shape[4] = {4, 3, 4, 6};
...
unsigned config5_transpose_v_from_shape[4] = {3, 4, 4, 4};
unsigned config5_transpose_v_to_shape[4] = {4, 3, 4, 4};
...
unsigned config5_transpose_output_from_shape[4] = {4, 3, 4, 4};
unsigned config5_transpose_output_to_shape[4] = {3, 4, 4, 4};
unsigned config5_transpose_output_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_output_perm_strides[4] = {16, 48, 4, 1};
