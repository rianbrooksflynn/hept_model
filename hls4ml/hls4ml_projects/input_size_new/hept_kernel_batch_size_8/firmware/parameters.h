...
unsigned config5_transpose_qk_from_shape[4] = {2, 8, 4, 6};
unsigned config5_transpose_qk_to_shape[4] = {8, 2, 4, 6};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {24, 192, 6, 1};
...
unsigned config5_transpose_v_from_shape[4] = {2, 8, 4, 4};
unsigned config5_transpose_v_to_shape[4] = {8, 2, 4, 4};
unsigned config5_transpose_v_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_v_perm_strides[4] = {16, 128, 4, 1};
...
unsigned config5_transpose_output_from_shape[4] = {8, 2, 4, 4};
unsigned config5_transpose_output_to_shape[4] = {2, 8, 4, 4};
unsigned config5_transpose_output_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_output_perm_strides[4] = {16, 32, 4, 1};
...
struct config5 : nnet::hept_config {
    ...
    static const unsigned batch_size = 8;
