...
unsigned config5_transpose_v_from_shape[4] = {2, 2, 2, 4};
unsigned config5_transpose_v_to_shape[4] = {2, 2, 2, 4};
...
unsigned config5_transpose_output_from_shape[4] = {2, 2, 2, 4};
unsigned config5_transpose_output_to_shape[4] = {2, 2, 2, 4};
