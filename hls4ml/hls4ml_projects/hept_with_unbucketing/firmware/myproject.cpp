...
void myproject(
    ...
    #pragma HLS INTERFACE ap_vld port=query,key,value,combined_shifts,layer5_out 
    #pragma HLS PIPELINE
    ...
    nnet::hept<input_t, result_t, config5>(query, key, value, combined_shifts, layer5_out); // hept
