...
module AESL_automem_padding_mask (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.myproject.autotvin_padding_mask.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.myproject.autotvout_padding_mask.dat"; 
//------------------------Local signal-------------------
