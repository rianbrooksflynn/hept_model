...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         ...
         "c.myproject.autotvin_value_r.dat"
         "c.myproject.autotvin_padding_mask.dat"
         "c.myproject.autotvin_layer5_out.dat"
         "c.myproject.autotvout_layer5_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_layer5_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
