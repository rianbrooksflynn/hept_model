...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.myproject.autotvin_query.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.myproject.autotvout_query.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 16;
parameter ADDR_WIDTH = 32'd 9;
parameter DEPTH = 32'd 288;
parameter DLY = 0.1;
