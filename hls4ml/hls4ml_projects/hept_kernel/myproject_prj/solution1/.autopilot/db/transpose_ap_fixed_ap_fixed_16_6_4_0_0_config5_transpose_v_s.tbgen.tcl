set moduleName transpose_ap_fixed_ap_fixed_16_6_4_0_0_config5_transpose_v_s
set isTopModule 0
...
set C_modelName {transpose<ap_fixed,ap_fixed<16,6,4,0,0>,config5_transpose_v>}
set C_modelType { void 0 }
set C_modelArgList {
	{ value_r int 16 regular {array 144 { 1 1 } 1 1 }  }
	{ res int 16 regular {array 144 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ value_r_address0 sc_out sc_lv 8 signal 0 } 
	{ value_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ value_r_q0 sc_in sc_lv 16 signal 0 } 
	{ value_r_address1 sc_out sc_lv 8 signal 0 } 
	{ value_r_ce1 sc_out sc_logic 1 signal 0 } 
	{ value_r_q1 sc_in sc_lv 16 signal 0 } 
	{ res_address0 sc_out sc_lv 8 signal 1 } 
	{ res_ce0 sc_out sc_logic 1 signal 1 } 
	{ res_we0 sc_out sc_logic 1 signal 1 } 
	{ res_d0 sc_out sc_lv 16 signal 1 } 
	{ res_address1 sc_out sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "res_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "res", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "transpose_ap_fixed_ap_fixed_16_6_4_0_0_config5_transpose_v_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	transpose_ap_fixed_ap_fixed_16_6_4_0_0_config5_transpose_v_s {
		value_r {Type I LastRead 72 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	res { ap_memory {  { res_address0 mem_address 1 8 }  { res_ce0 mem_ce 1 1 }  { res_we0 mem_we 1 1 }  { res_d0 mem_din 1 16 }  { res_address1 MemPortADDR2 1 8 }  { res_ce1 MemPortCE2 1 1 }  { res_we1 MemPortWE2 1 1 }  { res_d1 MemPortDIN2 1 16 } } }
}
