...
unsigned config5_transpose_qk_from_shape[4] = {1, 2, 2, 8};
unsigned config5_transpose_qk_to_shape[4] = {2, 1, 2, 8};
...
unsigned config5_transpose_v_from_shape[4] = {1, 2, 2, 2};
unsigned config5_transpose_v_to_shape[4] = {2, 1, 2, 2};
...
unsigned config5_transpose_output_from_shape[4] = {2, 1, 2, 2};
unsigned config5_transpose_output_to_shape[4] = {1, 2, 2, 2};
