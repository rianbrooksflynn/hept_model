...
unsigned config5_transpose_qk_from_shape[4] = {1, 4, 4, 12};
unsigned config5_transpose_qk_to_shape[4] = {4, 1, 4, 12};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {48, 192, 12, 1};
...
unsigned config5_transpose_v_from_shape[4] = {1, 4, 4, 6};
unsigned config5_transpose_v_to_shape[4] = {4, 1, 4, 6};
...
unsigned config5_transpose_output_from_shape[4] = {4, 1, 4, 6};
unsigned config5_transpose_output_to_shape[4] = {1, 4, 4, 6};
