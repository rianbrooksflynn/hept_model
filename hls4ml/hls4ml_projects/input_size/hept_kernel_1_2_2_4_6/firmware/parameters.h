...
unsigned config5_transpose_qk_from_shape[4] = {1, 2, 2, 10};
unsigned config5_transpose_qk_to_shape[4] = {2, 1, 2, 10};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {20, 40, 10, 1};
...
unsigned config5_transpose_v_from_shape[4] = {1, 2, 2, 4};
unsigned config5_transpose_v_to_shape[4] = {2, 1, 2, 4};
unsigned config5_transpose_v_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_v_perm_strides[4] = {8, 16, 4, 1};
...
unsigned config5_transpose_output_from_shape[4] = {2, 1, 2, 4};
unsigned config5_transpose_output_to_shape[4] = {1, 2, 2, 4};
unsigned config5_transpose_output_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_output_perm_strides[4] = {8, 8, 4, 1};
