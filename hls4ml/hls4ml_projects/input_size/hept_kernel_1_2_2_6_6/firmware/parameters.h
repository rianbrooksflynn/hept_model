...
unsigned config5_transpose_qk_from_shape[4] = {1, 2, 2, 12};
unsigned config5_transpose_qk_to_shape[4] = {2, 1, 2, 12};
unsigned config5_transpose_qk_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_qk_perm_strides[4] = {24, 48, 12, 1};
...
unsigned config5_transpose_v_from_shape[4] = {1, 2, 2, 6};
unsigned config5_transpose_v_to_shape[4] = {2, 1, 2, 6};
unsigned config5_transpose_v_perm[4] = {1, 0, 2, 3};
unsigned config5_transpose_v_perm_strides[4] = {12, 24, 6, 1};
...
unsigned config5_transpose_output_from_shape[4] = {2, 1, 2, 6};
unsigned config5_transpose_output_to_shape[4] = {1, 2, 2, 6};
