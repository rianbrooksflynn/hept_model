...
unsigned config4_transpose_qk_from_shape[4] = {1, 1, 100, 30};
unsigned config4_transpose_qk_to_shape[4] = {1, 1, 30, 100};
unsigned config4_transpose_qk_perm[4] = {0, 1, 3, 2};
unsigned config4_transpose_qk_perm_strides[4] = {3000, 3000, 1, 30};
